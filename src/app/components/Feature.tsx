  ...
  return (
    <div className="container pt-10">
      ...
      <p className="max-w-[550px] pt-10 text-gray-700">
        ...
        fugiat beatae quam nisi possimus ab impedit placeat dolorum eaque quae
        animi, ad optio dolores quasi esse magnam quisquam voluptates.
      </p>
      ...
      <div className="grid md:grid-cols-[1fr,37%,1fr] gap-16 mt-10 ">
        <div className="w-fit mx-auto self-end">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-700 text-[14px] xl-text-[16px]">
              ...
              Voluptatum dolores vel exercitationem laboriosam eaque, labore
            </p>
          </div>
        </div>
        ...
        <div className="w-fit mx-auto self-end">
          ...
          <div className="space-y-4">
            <Dash />
            <h2 className="font-medium text-xl">Backed Apples</h2>
            <p className="text-gray-700 text-[14px] xl-text-[16px]">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Voluptatum dolores vel exercitationem laboriosam eaque, labore
            </p>
